...
#undef _tt
      ...
      tcout << _T("u8str_wstr(u8\"Мама мыла раму\") -> ");
      wcout << u8str_wstr(u8"Мама мыла раму");

      tcout << _T("\nwstring -> string UTF-8 | ");
#ifdef _WIN32
      tcout << _T("wstr_u8str(L\"Мама мыла раму\") -> ")
            << _T("пропускаем тест");
#elif __linux__
      ...
      tcout << _T("\nstring -> tstring | ");
      tcout << _T("str2tstr(\"Мама мыла раму\") -> ");
      tcout << str2tstr("Мама мыла раму");

      tcout << _T("\ntstring -> string | ");
      tcout << _T("tstr2str(_T(\"Мама мыла раму\")) -> ");
      cout << tstr2str(_T("Мама мыла раму"));

      tcout << _T("\nwstring -> tstring | ");
      tcout << _T("wstr2tstr(L\"Мама мыла раму\") -> ");
      tcout << wstr2tstr(L"Мама мыла раму");

      tcout << _T("\ntstring -> wstring | ");
      tcout << _T("tstr2wstr(_T(\"Мама мыла раму\")) -> ");
      wcout << tstr2wstr(_T("Мама мыла раму"));

      tcout << _T("\nu16string -> tstring | ");
      tcout << _T("ustr2tstr(u\"Мама мыла раму\") -> ");
      tcout << ustr2tstr(u"Мама мыла раму");

      tcout << _T("\ntstring -> u16string | ");
      tcout << _T("tstr2ustr(_T(\"Мама мыла раму\")) -> ");
      tcout << ustr2tstr(tstr2ustr(_T("Мама мыла раму")));
      ...
      tcout << _T("\nУдалим в \"  \\n \\b \\a \\v \\t \\b Мама Мыла Раму  \"    лидирующие пробелы: ") << remove_left_spaces(_T("  \n \b \a \v \t \b Мама Мыла Раму  ")) << _T("<-- end");
      tcout << _T("\nУдалим в \"  Мама Мыла Раму  \\n \\b \\a \\v \\t \\b \"   заверщающие пробелы: ") << remove_right_spaces(_T("  Мама Мыла Раму  \n \b \a \v \t \b ")) << _T("<-- end");
