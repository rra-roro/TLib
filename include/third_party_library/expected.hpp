    ...
    namespace nonstd
{
      ...
      namespace expected_lite
      {
                  ...
                  nsel_constexpr14 expected(expected &&other
                          nsel_REQUIRES_A(
                              std::is_move_constructible<T>::value
                                  &&std::is_move_constructible<E>::value)) noexcept(std::is_nothrow_move_constructible<T>::value
            ...
            auto make_expected_from_call(F f,
                nsel_REQUIRES_A(!std::is_same<typename std::result_of<F()>::type, void>::value)) -> expected<typename std::result_of<F()>::type>
            {
                  try
                  {
            ...
            /*nsel_constexpr14*/
            auto make_expected_from_call(F f,
                nsel_REQUIRES_A(std::is_same<typename std::result_of<F()>::type, void>::value)) -> expected<void>
            {
                  try
                  {
                        f();
