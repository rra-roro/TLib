...
#elif _WIN32
      u16ostream ucout(&out_bufferconvert_u16_o);
      u16istream ucin(&in_bufferconvert_u16_o);
      u16ostream ucerr(&err_bufferconvert_u16_o);
      u16ostream uclog(&log_bufferconvert_u16_o);
#endif
